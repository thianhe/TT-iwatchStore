        ...
        <div class="col-xs-11 col-sm-10 col-md-8">
            <form role="form" method="post" action="<?=Config::BASE_URL?>do_register" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="account" id="account" class="form-control input-lg" required placeholder="Account"
                        value="<?php if(isset($error)){ echo htmlspecialchars($_POST['account'], ENT_QUOTES); } ?>"
                        tabindex="1">
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="firstName" id="firstName" class="form-control input-lg" required
                                placeholder="First Name" value="<?php if(isset($error)){ echo htmlspecialchars($_POST['firstName'], ENT_QUOTES); } ?>"
                                tabindex="5">
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
